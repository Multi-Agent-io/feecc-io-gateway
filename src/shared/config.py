...
config: GlobalConfig = _load_config("config.yaml", GlobalConfig)
camera_config: tp.List[CameraConfigSection] = _load_config("camera_config.yaml", tp.List[CameraConfigSection])
